...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bar_spirit', (
            ...
            ('age', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('web', self.gf('django.db.models.fields.URLField')(max_length=255, null=True)),
    ...
    models = {
        ...
        u'bar.spirit': {
            ...
            'web': ('django.db.models.fields.URLField', [], {'max_length': '255', 'null': 'True'})
        },
        u'bar.spirittype': {
