...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spirit.volume'
        db.alter_column(u'bar_spirit', 'volume', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Spirit.volume'
        db.alter_column(u'bar_spirit', 'volume', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'bar.spirit': {
            ...
            'volume': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '2'}),
