...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Distillery.capacity'
        raise RuntimeError("Cannot reverse this migration. 'Distillery.capacity' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Distillery.founded'
        raise RuntimeError("Cannot reverse this migration. 'Distillery.founded' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Distillery.location'
        raise RuntimeError("Cannot reverse this migration. 'Distillery.location' and its values cannot be restored.")
    ...
    models = {
        u'bar.distillery': {
            ...
            'founded': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
